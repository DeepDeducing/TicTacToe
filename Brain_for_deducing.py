...
class Brain(object):
    ...
    def train_for_input_value(self,
        ...
        self.given_and_missing_input_value  += layer_delta  * self.beta    * self.given_and_missing_input_value_resistor


    def deduce_batch(self, given_and_missing_input_value, given_and_missing_input_value_resistor, desired_output, weight_list, slope_list):
        ...
        self.given_and_missing_input_value          = given_and_missing_input_value
        self.given_and_missing_input_value_resistor = given_and_missing_input_value_resistor


        layer_list = self.generate_values_for_each_layer(self.activator( self.given_and_missing_input_value ))
        self.train_for_input_value(layer_list, desired_output)


        return self.given_and_missing_input_value
